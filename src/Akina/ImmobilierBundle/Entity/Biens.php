...
class Biens
{
  ...
  private $Proprietaire;
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Akina\ImmobilierBundle\Entity\Image")
     */
  private $Image;
...
return $this->nomBien ;
     ...
     * Set image
     *
     * @param \Akina\ImmobilierBundle\Entity\Image $image
     *
     * @return Biens
     */
    public function setImage(\Akina\ImmobilierBundle\Entity\Image $image = null)
    {
        $this->Image = $image;
     ...
     * Get image
     *
     * @return \Akina\ImmobilierBundle\Entity\Image
     */
